...
if(mainTask.length>0){
  renderTask = mainTask.map((t,i)=>{
    ...
    className='bg-red-400 text-white px-4 py-2 rounded text-bold'>Delete</button>
     </li>
    )
 })
}
  ...
  return (
   <>
   <h1 className='bg-black text-white p-10 text-5xl font-bold text-center'>Sehaj's ToDoList</h1>
